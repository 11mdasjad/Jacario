...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-24">
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                ...
                <div class="lg:col-span-7 space-y-8 z-10">
                    <div class="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-white border border-zinc-200/90 shadow-xs text-[#8C6D46] text-xs font-bold uppercase tracking-widest">
                        <span class="w-2 h-2 rounded-full bg-[#A4845B]"></span>
                        <span>The Modern Haute Collection</span>
                    </div>

                    <h1 class="text-4xl sm:text-6xl lg:text-7xl font-serif-luxury font-bold tracking-tight text-zinc-950 leading-[1.08]">
                        The Polo, <br>
                        <span class="gold-gradient-text">Perfected.</span>
                    </h1>

                    <p class="text-base sm:text-lg text-zinc-600 max-w-xl font-light leading-relaxed">
                    ...
                    <div class="flex flex-col sm:flex-row items-stretch sm:items-center space-y-3 sm:space-y-0 sm:space-x-4 pt-2">
                        <a href="{{ route('shop.index', ['category' => 'mens-polo-t-shirts']) }}" class="px-8 py-4 bg-zinc-950 hover:bg-black text-white text-xs font-bold uppercase tracking-[0.2em] rounded-xl text-center transition-all duration-300 shadow-md hover:shadow-xl hover:scale-[1.02]">
                            Shop Polo T-Shirts
                        </a>
                        <a href="#styles" class="px-8 py-4 border border-zinc-300 hover:border-zinc-950 text-zinc-900 bg-white/80 hover:bg-white text-xs font-bold uppercase tracking-[0.2em] rounded-xl text-center transition-all shadow-xs">
                            Explore Collections
                        </a>
                    </div>

                    <!-- Value Highlights -->
                    <div class="grid grid-cols-3 gap-6 pt-8 border-t border-zinc-200">
                        <div>
                            <p class="text-2xl font-serif-luxury font-bold text-zinc-950">100%</p>
                            <p class="text-[11px] text-zinc-500 uppercase tracking-wider mt-0.5 font-medium">Supima® & Silk</p>
                        </div>
                        <div>
                            <p class="text-2xl font-serif-luxury font-bold text-zinc-950">240 GSM</p>
                            <p class="text-[11px] text-zinc-500 uppercase tracking-wider mt-0.5 font-medium">Piqué Weight</p>
                        </div>
                        <div>
                            <p class="text-2xl font-serif-luxury font-bold text-zinc-950">Zero</p>
                            <p class="text-[11px] text-zinc-500 uppercase tracking-wider mt-0.5 font-medium">Collar Roll Guarantee</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:col-span-5 relative flex justify-center">
                    <div class="relative w-full max-w-md aspect-[4/5] rounded-3xl bg-white border border-zinc-200 flex items-center justify-center shadow-2xl overflow-hidden group">
                        ...
                        <div class="absolute top-4 right-4 bg-white/95 backdrop-blur-md text-[#8C6D46] border border-zinc-200 rounded-full w-14 h-14 flex flex-col items-center justify-center text-center z-10 shadow-md">
                            <span class="text-[9px] font-bold tracking-widest uppercase">EST.</span>
                            <span class="text-[10px] font-bold text-zinc-900">2026</span>
                        </div>
                        ...
                        <div class="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-md rounded-2xl p-4 border border-zinc-200/90 flex items-center justify-between z-10 shadow-lg">
                            <div>
                                <p class="text-xs font-bold text-zinc-950">Signature Obsidian Supima®</p>
                                <p class="text-[11px] text-[#8C6D46] font-medium">Mother-of-Pearl Shell Buttons</p>
                            </div>
                            <span class="text-xs font-bold text-zinc-950 bg-zinc-100 px-3 py-1.5 rounded-lg border border-zinc-200">₹1,999</span>
                        </div>
                    </div>
                </div>
    ...
    <section id="styles" class="py-20 bg-white border-b border-zinc-200/80">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            
            <div class="text-center max-w-2xl mx-auto mb-14">
                <p class="text-xs font-bold uppercase tracking-[0.25em] text-[#8C6D46] mb-2">Curated Silhouettes</p>
                <h2 class="text-3xl sm:text-4xl font-serif-luxury font-bold text-zinc-950 tracking-tight">
                    Signature Collections
                </h2>
                <p class="text-sm text-zinc-500 mt-3 font-light">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                @foreach($categories as $category)
                    <a href="{{ route('shop.index', ['category' => $category->slug]) }}" class="group relative rounded-3xl bg-zinc-900 overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 flex flex-col justify-end aspect-[4/5] border border-zinc-200">
                        ...
                        <div class="relative p-8 z-10 space-y-2">
                            <span class="text-[10px] font-bold uppercase tracking-[0.25em] text-[#DFCAAB]">Explore Collection</span>
                            <h3 class="text-2xl font-serif-luxury font-bold text-white group-hover:text-[#DFCAAB] transition-colors">{{ $category->name }}</h3>
                            <p class="text-xs text-zinc-300 line-clamp-2 font-light">{{ $category->description }}</p>
                            <span class="inline-flex items-center space-x-2 text-xs font-bold uppercase tracking-widest text-white pt-2 group-hover:text-[#DFCAAB] transition-colors">
                                <span>Shop Now</span>
    ...
    <section class="py-20 bg-[#FAF8F5]">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
                <div>
                    <p class="text-xs font-bold uppercase tracking-[0.25em] text-[#8C6D46] mb-2">Customer Favorites</p>
                    <h2 class="text-3xl font-serif-luxury font-bold text-zinc-950 tracking-tight">Best Sellers</h2>
                </div>
                <a href="{{ route('shop.index', ['collection' => 'bestsellers']) }}" class="mt-4 md:mt-0 text-xs font-bold uppercase tracking-widest text-zinc-900 hover:text-[#8C6D46] transition-colors flex items-center space-x-1">
    ...
    <section class="py-24 bg-white border-y border-zinc-200/80">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            
            <div class="text-center max-w-2xl mx-auto mb-16">
                <p class="text-xs font-bold uppercase tracking-[0.25em] text-[#8C6D46] mb-2">Uncompromising Standard</p>
                <h2 class="text-3xl sm:text-4xl font-serif-luxury font-bold text-zinc-950 tracking-tight">
                    Why JACARIO
                </h2>
                <p class="text-sm text-zinc-500 mt-3 font-light">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <!-- Pillar 1 -->
                <div class="p-8 rounded-3xl bg-[#FAF8F5] border border-zinc-200/80 space-y-4 hover:shadow-lg transition-all">
                    <div class="w-12 h-12 rounded-2xl bg-white border border-zinc-200 flex items-center justify-center text-[#8C6D46] shadow-xs">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z"/></svg>
                    </div>
                    <h3 class="text-lg font-serif-luxury font-bold text-zinc-950">Rare Supima® & Silk</h3>
                ...
                <div class="p-8 rounded-3xl bg-[#FAF8F5] border border-zinc-200/80 space-y-4 hover:shadow-lg transition-all">
                    ...
                    <h3 class="text-lg font-serif-luxury font-bold text-zinc-950">Anti-Curl Collar Engineering</h3>
                    <p class="text-xs text-zinc-600 leading-relaxed font-light">
                ...
                <div class="p-8 rounded-3xl bg-[#FAF8F5] border border-zinc-200/80 space-y-4 hover:shadow-lg transition-all">
                    <div class="w-12 h-12 rounded-2xl bg-white border border-zinc-200 flex items-center justify-center text-[#8C6D46] shadow-xs">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M14.121 14.121L19 19m-7-7l7-7m-7 7l-2.879 2.879a3 3 0 01-4.242 0 3 3 0 010-4.242L10.758 4.879a3 3 0 014.242 0 3 3 0 010 4.242z"/></svg>
                    </div>
                    <h3 class="text-lg font-serif-luxury font-bold text-zinc-950">Mother-of-Pearl Hardware</h3>
                    <p class="text-xs text-zinc-600 leading-relaxed font-light">
                ...
                <div class="p-8 rounded-3xl bg-[#FAF8F5] border border-zinc-200/80 space-y-4 hover:shadow-lg transition-all">
                    <div class="w-12 h-12 rounded-2xl bg-white border border-zinc-200 flex items-center justify-center text-[#8C6D46] shadow-xs">
                        <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M9 19l3 3m0 0l3-3m-3 3V10"/></svg>
                    </div>
                    <h3 class="text-lg font-serif-luxury font-bold text-zinc-950">Pre-Shrunk Precision Fit</h3>
                    <p class="text-xs text-zinc-600 leading-relaxed font-light">
                ...
                <div class="p-8 rounded-3xl bg-[#FAF8F5] border border-zinc-200/80 space-y-4 hover:shadow-lg transition-all">
                    ...
                    <h3 class="text-lg font-serif-luxury font-bold text-zinc-950">15-Day Doorstep Exchanges</h3>
                    <p class="text-xs text-zinc-600 leading-relaxed font-light">
                ...
                <div class="p-8 rounded-3xl bg-[#FAF8F5] border border-zinc-200/80 space-y-4 hover:shadow-lg transition-all">
                    ...
                    <h3 class="text-lg font-serif-luxury font-bold text-zinc-950">Encrypted & Secure Payments</h3>
                    <p class="text-xs text-zinc-600 leading-relaxed font-light">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row md:items-end justify-between mb-12">
                <div>
                    <p class="text-xs font-bold uppercase tracking-[0.25em] text-[#8C6D46] mb-2">Latest Atelier Releases</p>
                    <h2 class="text-3xl font-serif-luxury font-bold text-zinc-950 tracking-tight">New Arrivals</h2>
                </div>
                <a href="{{ route('shop.index', ['collection' => 'new-arrivals']) }}" class="mt-4 md:mt-0 text-xs font-bold uppercase tracking-widest text-zinc-900 hover:text-[#8C6D46] transition-colors flex items-center space-x-1">
                    <span>Explore New Season</span>
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"/></svg>
                </a>
            </div>
