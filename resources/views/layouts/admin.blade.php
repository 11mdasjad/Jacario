...
<body class="h-full text-zinc-900 flex overflow-hidden bg-[#F8FAFC] font-sans" x-data="{ sidebarOpen: false }">
    ...
    <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'"
        ...
        <div>
            <!-- Brand Logo -->
            <div class="h-24 flex items-center justify-between px-6 border-b border-zinc-200">
                <a href="{{ route('admin.dashboard') }}" class="flex items-center space-x-2">
                    <img src="{{ asset('images/logo.png') }}" alt="JACARIO" class="h-12 sm:h-14 w-auto object-contain">
                </a>
